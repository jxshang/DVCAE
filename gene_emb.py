...
# paths
flags.DEFINE_string ('input', './dataset/aps/', 'Dataset path.')
...
def write_cascade(graphs, labels, id2row, filename, gg_emb, weight=True):
    ...
    with open(filename, 'wb') as f:
        pickle.dump((cascade_input, global_input, y_data, cascade_graphs), f)
